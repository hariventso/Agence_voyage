...
export const LanguageSwitcher = () => {
  ...
  const styles = {
    ...
    button: {
      ...
      alignItems: 'center',
      gap: '8px',
      backgroundColor: btnHovered ? 'rgba(255, 140, 0, 0.15)' : 'rgba(128, 128, 128, 0.1)',
      border: btnHovered ? '1px solid rgba(255, 140, 0, 0.3)' : '1px solid rgba(128, 128, 128, 0.2)',
      padding: '6px 14px',
      borderRadius: '20px',
      cursor: 'pointer',
    ...
    dropdown: {
      ...
      borderRadius: '12px',
      boxShadow: '0 10px 25px rgba(0, 0, 0, 0.12), 0 4px 12px rgba(0, 0, 0, 0.04)',
