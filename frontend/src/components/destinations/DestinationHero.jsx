...
const DestinationHero = ({ isMobile }) => {
  ...
  return (
    <section style={{
      ...
      <img src="/image/isalo_destination.png" alt={t("Parc National de l'Isalo")} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', zIndex: 0 }} />
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, padding: '0 20px' }}>
        ...
        <p style={{ color: '#FFFFFF', fontSize: '1.2rem', lineHeight: 1.6, maxWidth: '800px', margin: '0 auto', fontWeight: 400 }}>
          {t("Explorez les merveilles de Madagascar à travers nos circuits authentiques.")}
        </p>
      </div>
    </section>
  );
